...
Analysis 1 -
Every employee commmunicates with every other employee. This analysis
calculate the No of emails sent from every employee to every other employee (Basically a Many to Many calculation)
Data is sorted to check which two employees have communicated the most. May be checking those emails may provide some clue to
...
Articles - About Sports Celebs mainly Tennis
Books - Books data containing publishers name,group where book belongs etc
...
and reports a data of how many articles were published every month for each of the celebrity .

Analysis 2(books.ipynb)-
Each book many belong to category like Fiction,Thriller,for Children etc.
This Analysis calculates how many books are present under each category.
Sort the Books present under each category based on rank.
Report the Top three most rated books and last three least rated book for the viewer under each category.
